...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView.tag == 100) {
        ...
        if (indexPath.section == 0) {
            ...
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"关于酷炫音乐" message:@"旨在技术分享" preferredStyle:UIAlertControllerStyleAlert];
            ...
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"开发者" message:@"联系邮箱：lvwenyuanprobe@163.com" preferredStyle:UIAlertControllerStyleAlert];
            UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault
                                                                  handler:^(UIAlertAction * action) {
